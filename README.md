...
이 프로젝트는 이벤트 성과를 단순히 유입 수나 매출만으로 판단하지 않고,  
...
유저 행동 데이터를 기반으로 KMeans 군집 분석을 수행하고,  
Vertex AI를 활용해 각 군집에 사람이 이해하기 쉬운 이름을 부여했습니다.
...
이벤트 성과 대시보드는 GA4 이벤트 데이터를 기반으로  
이벤트별 유입, 페이지 반응, 구매전환, 참여전환, 매출 성과를 한 화면에서 비교할 수 있도록 구성했습니다.
