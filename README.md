...
<small> --> 이거 작은 글씨로 하는 법 알려줘 인덱스 처럼 
X축: UX 상호 작용 점수
Y축: 구매, 참여전환률
버블 크기: 유입, 매출 규모
...
4. [대시보드 및 분석 결과](#4-대시보드-및-분석-결과) --> 자세히 보기 
8. [데이터 구조](#8-데이터-구조)
9. [프로젝트 결과](#9-프로젝트-결과)
...
**흐름: 유저 행동, 군집 분석 → 이벤트 성과 분석 → 이벤트 + 유저 데이터 → AI 인사이트 → 최종 결과**
